	...
	if($_SESSION['membertype'] == 2) {
		...
		if($_SERVER['REQUEST_METHOD'] === 'GET') {
			...
			if(isset($_GET['supplierID'])) {
				...
				$stmt1->bind_param("s", $_GET['supplierID']);
				...
				if($_SESSION['membertype'] == 2) {
					...
					<div class="collapse navbar-collapse" id="navbarNav">
						<ul class="navbar-nav ml-lg-auto">
							...
							<input name="supplierID" type="search" class="dark" placeholder="Search Supplier ID">
							</form>
							</li>
						</ul>
					</div>
				...
				<div class="table-responsive mt-3">
					<table class="table table-dark table-borderless">
						...
						<?php
							foreach($row1 as $r) {
								echo '<tr>
								<td> <span class="mr-1"></span> <a style="color: #fff" href="../supplier?supplierID='.$r['supplier_id'].'">' . $r['sname'] . '</a> </td>
								<td> <span class="mr-1"></span> <a style="color: #fff" href="../product?productID='.$r['product_id'].'">' . $r['pname'] . '</a> </td>
								<td> <span class="mr-1"></span> ' . $r['brand'] . ' </td>
								<td> <span class="mr-1"></span> ' . $r['stock'] . ' </td>
								<td> <span class="mr-1"></span> ' . $r['price'] . ' </td>
								<td> <span class="mr-1"></span> <a style="color: #fff" href="../category?categoryID='.$r['category_id'].'">' . $r['cname'] . '</a> </td>
							</tr>
								';
							}
						?>
